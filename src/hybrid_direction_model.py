...
# Load direction data
X_train = np.load("data/processed/X_train_dir.npy")
X_test = np.load("data/processed/X_test_dir.npy")
y_train = np.load("data/processed/y_train_dir.npy")
y_test = np.load("data/processed/y_test_dir.npy")
...
callbacks = [
    ...
    ModelCheckpoint("models/hybrid_direction_model.h5", save_best_only=True)
]
...
print("Direction Model Training Completed ✅")
